...
const (
	RecommendationService_GetRecommendations_FullMethodName = "/recommendations.RecommendationService/GetRecommendations"
)
...
type RecommendationServiceClient interface {
	// Sends strengths and weaknesses and gets back recommendations.
...
var RecommendationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "recommendations.RecommendationService",
